    ...
    if(isset($_GET['get_id'])){
        ...
        while($f_cart = $varify_cart->fetch(PDO::FETCH_ASSOC)){
            if(isset($f_cart['product_id'])) {
                ...
                $warning_msg[] = 'Product ID missing in cart.';
            }
        }
...
<head>
    ...
    <title>Avon MakeUp - checkout Page</title>
                        ...
                        <div class="flex">
                            <div class="box">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="name" required maxlength="50" placeholder="Enter Your name" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>your number <sub>*</sub></p>
                                    <input type="number" name="number" required maxlength="10" placeholder="Enter Your number" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>your email <sub>*</sub></p>
                                    <input type="email" name="email" required maxlength="50" placeholder="Enter Your email" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>payment method <sub>*</sub></p>
                            ...
                            <div class="box">
                                <div class="input-field">
                                    <p>address line 01 <sub>*</sub></p>
                                    <input type="text" name="flat" required maxlength="50" placeholder="e.g flat & building number" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>address line 02 <sub>*</sub></p>
                                    <input type="text" name="street" required maxlength="50" placeholder="e.g street name" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>city name <sub>*</sub></p>
                                    <input type="text" name="city" required maxlength="50" placeholder="Enter your city name" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>country name <sub>*</sub></p>
                                    <input type="text" name="country" required maxlength="50" placeholder="Enter your country name" calss="input">
                                </div>
                                <div class="input-field">
                                    <p>pincode <sub>*</sub></p>
                                    <input type="text" name="pincode" required maxlength="6" placeholder="110022" min="0" max="999999" calss="input">
                                </div>
                                </div>
                        </div>
